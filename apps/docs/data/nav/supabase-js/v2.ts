const Nav = [
  ...
  },
  {
    label: '数据库',
    items: [
      { name: 'Select 查询', url: '/reference/javascript/select', items: [] },
      { name: 'Insert 数据', url: '/reference/javascript/insert', items: [] },
      { name: 'Update 数据', url: '/reference/javascript/update', items: [] },
      { name: 'Upsert 数据', url: '/reference/javascript/upsert', items: [] },
      { name: 'Delete 数据', url: '/reference/javascript/delete', items: [] },
      { name: '调用Postgres函数', url: '/reference/javascript/rpc', items: [] },
      {
        name: '过滤器',
        url: undefined,
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          { name: 'returns()', url: '/reference/javascript/db-returns', items: [] },
        ],
      },
    ],
  },
  {
    label: '认证',
    items: [
      { name: '概述', url: '/reference/javascript/auth-api', items: [] },
      { name: 'signUp()', url: '/reference/javascript/auth-signup', items: [] },
      { name: 'signInWithPassword()',url: '/reference/javascript/auth-signinwithpassword',items: [],},
      ...
      //{ name: 'signInWithSSO()', url: '/reference/javascript/auth-signinwithsso', items: [] },
      { name: 'signOut()', url: '/reference/javascript/auth-signout', items: [] },
      { name: 'resetPasswordForEmail()',url: '/reference/javascript/auth-resetpasswordforemail',items: [],},
      ...
      //{ name: 'reAuthentication()', url: '/reference/javascript/auth-reauthentication', items: [] },
      //{ name: 'reSend()', url: '/reference/javascript/auth-resend', items: [] },
      { name: 'setSession()', url: '/reference/javascript/auth-setsession', items: [] },
      { name: 'onAuthStateChange()',url: '/reference/javascript/auth-onauthstatechange',items: [],},
      //{ name: 'exchangeCodeForSession()',url: '/reference/javascript/auth-exchangecodeforsession',items: [],},
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'inviteUserByEmail()',url: '/reference/javascript/auth-admin-inviteuserbyemail',items: [],},
      { name: 'generateLink()', url: '/reference/javascript/auth-admin-generatelink', items: [] },
      { name: 'updateUserById()',url: '/reference/javascript/auth-admin-updateuserbyid',items: [],},
      //{ name: 'mfa.listFactors()',url: '/reference/javascript/auth-admin-mfa-listfactors',items: [],},
      //{ name: 'mfa.deleteFactor()',url: '/reference/javascript/auth-admin-mfa-deletefactor',items: [],},
    ],
  },
  {
    label: '函数',
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'from.createSignedUrl()',url: '/reference/javascript/storage-from-createsignedurl',items: [],},
      { name: 'from.createSignedUrls()',url: '/reference/javascript/storage-from-createsignedurls',items: [],},
      { name: 'from.createSignedUploadUrls()',url: '/reference/javascript/storage-from-createsigneduploadurl',items: [],},
      { name: 'from.uploadToSignedUrl()',url: '/reference/javascript/storage-from-uploadtosignedurl',items: [],},
      { name: 'from.getPublicUrl()',url: '/reference/javascript/storage-from-getpublicurl',items: [],},
    ],
  },
]
