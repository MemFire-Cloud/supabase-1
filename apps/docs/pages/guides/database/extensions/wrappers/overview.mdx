...
如果您想要将任何列公开到您的公共 API，可以在 `public`模式中创建一个 [视图](https://supabase.com/docs/guides/database/tables#views)。您也可以在 [数据库函数](https://supabase.com/docs/guides/database/functions) 中与您的外部表交互。
